        ...
        >
          ...
          >
            ...
            <header className="text-center">
              <p className="text-sm font-semibold tracking-wider text-primary sm:text-base xl:text-[28px] xl:leading-[40px] xl:tracking-normal">
                <span className="xl:text-[#484B4D]">가치관 </span>
                <span>TALK</span>
              </p>
              <h3 className="mt-2 text-[20px] leading-[28px] font-semibold tracking-tight text-[#1b1a2a] sm:text-[24px] sm:leading-[32px] xl:text-[20px] xl:leading-[32px] xl:font-medium xl:text-[#6C7073]">
                당신의 생각을 자유롭게 적어요
              </h3>
            </header>
          </article>
