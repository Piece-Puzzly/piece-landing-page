  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1440px] flex-col items-center gap-[64px] px-6 py-16 md:px-10 md:py-20 xl:gap-[96px] xl:px-12 xl:py-[120px]">
        ...
        <div className="flex w-full flex-col items-center gap-[64px] xl:flex-row xl:items-stretch xl:gap-[40px]">
          <article className="flex w-full max-w-[440px] flex-col items-center gap-6 xl:max-w-none xl:flex-[1_0_0] xl:gap-8">
            <img
              src="/talk-card.png"
